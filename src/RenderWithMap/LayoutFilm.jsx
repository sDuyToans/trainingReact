...
import '../assets/scss/LayoutFilm.scss';
...
export default class LayoutFilm extends Component {
    ...
    renderFilm = () =>{
        return data.map(film =>{
            return (
            <div className="card text-start" key={film.maPhim}>
                <img className="card-img-top" src={film.hinhAnh} alt="..." />
                <div className="card-body">
                    <h4 className="card-title" style={{height: 75}}>{film.tenPhim}</h4>
                    <p className="card-text" style={{height: 75}}>{film.moTa.length > 100? film.moTa.slice(0, 100) + '...' : film.moTa}</p>
                </div>
            </div>
          )
        })
    ...
    return (
      <div className="film-container">
       ...
       <header>
        ...
        <section className="render-movie">
            {this.renderFilm()}
        </section>
       </div>
      </div>
