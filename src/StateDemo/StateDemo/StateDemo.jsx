...
export default class StateDemo extends Component {
    //state : là thuộc tính có sẵn của react class component. Khi state thay đổi thì
    //giao diện sẽ tự render lại
    state = {
        login: false,
        stateA: 'a',
        stateB: 'b'
    ...
    handleLogin =  () =>{
            // this.state.login = true; // Không được thay đổi state trực tiếp mà phải thông qua setState
        ...
        /*
         ...
         + setState là phương thức bất đồng bộ. async await
        */
